...
{/* Background arc - Soccer field green */}
<path d="M 20 100 A 80 80 0 0 1 180 100" fill="none" stroke="rgba(76, 175, 80, 0.3)" strokeWidth="8" strokeLinecap="round" />
      ...
      {/* Needle - Yellow like a soccer card */}
      <line
        x1="100"
        y1="100"
        x2="100"
  ...
  <div className={styles.achievement}>
    <div className={styles.achievementLabel}>Goal Completion Rate</div>
